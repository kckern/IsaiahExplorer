...
export function VerseBox({ verse_id, class: baseClasses, title, box_num }) {
  ...
  var parsedVerseId = parseInt(verse_id, 10);

  var isActive = parseInt(state.active_verse_id, 10) === parsedVerseId;
  ...
  var isSelected = parseInt(state.selected_verse_id, 10) === parsedVerseId;
